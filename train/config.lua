...
config.model = {}
-- #alphabet x 1014
config.model[1] = {module = "cudnn.TemporalConvolution", inputFrameSize = #alphabet, outputFrameSize = 256, kW = 7}
config.model[2] = {module = "nn.Threshold"}
config.model[3] = {module = "nn.TemporalMaxPooling", kW = 3, dW = 3}
-- 336 x 256
config.model[4] = {module = "cudnn.TemporalConvolution", inputFrameSize = 256, outputFrameSize = 256, kW = 7}
config.model[5] = {module = "nn.Threshold"}
config.model[6] = {module = "nn.TemporalMaxPooling", kW = 3, dW = 3}
-- 110 x 256
config.model[7] = {module = "cudnn.TemporalConvolution", inputFrameSize = 256, outputFrameSize = 256, kW = 3}
config.model[8] = {module = "nn.Threshold"}
-- 108 x 256
config.model[9] = {module = "cudnn.TemporalConvolution", inputFrameSize = 256, outputFrameSize = 256, kW = 3}
config.model[10] = {module = "nn.Threshold"}
-- 106 x 256
config.model[11] = {module = "cudnn.TemporalConvolution", inputFrameSize = 256, outputFrameSize = 256, kW = 3}
config.model[12] = {module = "nn.Threshold"}
-- 104 x 256
config.model[13] = {module = "cudnn.TemporalConvolution", inputFrameSize = 256, outputFrameSize = 256, kW = 3}
...
config.model[24] = {module = "cudnn.LogSoftMax"}
