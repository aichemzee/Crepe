...
function Model:createModule(m)
   ...
   elseif m.module == "cudnn.TemporalConvolution" then
   ...
   elseif m.module == "cudnn.LogSoftMax" then
...
function Model:makeCleanModule(m)
   if torch.typename(m) == "cudnn.TemporalConvolution" then
   ...
   elseif torch.typename(m) == "cudnn.LogSoftMax" then
